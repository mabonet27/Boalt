...
<head>
    ...
    <title>{{ config('app.name', 'Boalt') }}</title>
    <!-- Fonts -->
    ...
    <link href="{{ asset('assets/scss/variables.scss') }}" rel="stylesheet">
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('Boalt Assessment', 'Boalt Assessment') }}
                </a>
    ...
    <script src="https://kit.fontawesome.com/5f0004d928.js" crossorigin="anonymous"></script>
</body>
</html>
